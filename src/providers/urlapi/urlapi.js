...
var UrlapiProvider = /** @class */ (function () {
    function UrlapiProvider(httpClient) {
        this.httpClient = httpClient;
        this.urls = ['http://127.0.0.1:8000/api/', 'http://34.217.126.220/api/'];
        this.headers = new HttpHeaders({ 'Content-Type': 'application/json' });
    }
    UrlapiProvider.prototype.selectAvailableURL = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _i, _a, url, resutado;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        url = _a[_i];
                        return [4 /*yield*/, this.httpClient.get(url, this.headers).toPromise().then(function (sucesso) {
                                console.log(suceso);
                            }, function (erro) {
                                console.log(erro);
                            })];
