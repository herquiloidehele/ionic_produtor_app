...
var ProdutoMaisProduradosPage = /** @class */ (function () {
    function ProdutoMaisProduradosPage(navCtrl, navParams, urlApi) {
    ...
    ProdutoMaisProduradosPage.prototype.ionViewDidLoad = function () {
        this.produtos = this.navParams.get('produtos');
        this.mercado = this.navParams.get('mercado');
        this.produtosCopy = this.produtos;
    };
    ProdutoMaisProduradosPage.prototype.onInput = function (event) {
    ...
    ProdutoMaisProduradosPage = __decorate([
        IonicPage(),
        Component({
    ...
    return ProdutoMaisProduradosPage;
}());
export { ProdutoMaisProduradosPage };
//# sourceMappingURL=produto-mais-produrados.js.map